		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<p class="lead text-size">Fondée en 2011 BOUMAT TP est une entreprise familiale indépendante à taille humaine.
					...
					accès privés, réseau, assainissement, fosses septiques, espaces verts…
					Nous intervenons sur Toulouse et les environs.
					N’hésitez pas à nous <span class="font-weight-bold"><a class="color-logo" href="#">contacter</a></span>, nous serons ravie de répondre à vos besoins.
				</p>
			</div>
		</div>
...
<!-- NOS DOMAINES -->
		...
		<div class="container my-5">
			<h2 class="text-center mb-5">NOS DOMAINES</h2>
			<div class="row">
...
<!-- NOS REFERENCES -->
		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h2 class="text-center">NOS REFERENCES</h2>
				...
				<div class="row d-flex justify-content-around">
					<div class="card mb-3 max-width">
						<div class="row no-gutters">
							<div class="col-md-5">
								<img src="images/assets/espace-vert2.jpg" class="card-img" alt="espace-vert">
							</div>
							<div class="col-md-7">
								<div class="card-body">
...
<!--						<h1>Site en construction</h1><br />-->
<!--					</div>-->
<!--					<div class="main_content_content">-->
<!--					  <p>Pour toute information sur nos services <b>demande de devis/réalisation de chantier</b> merci de contacter <b>Alexis Mathieu</b><br />-->
<!--						- par mail : <a href="mailto:a.mathieu@boumat-tp.fr">a.mathieu@boumat-tp.fr</a><br />-->
<!--						- par téléphone : 06.60.16.37.95<br /><br />-->
<!--						  Pour toute information sur nos services <b>comptabilité/gestion</b> merci de contacter<br />-->
<!--						  <b>Dimitri Mathieu :</b><br />-->
<!--						- par mail : <a href="mailto:dimitri.mathieu@boumat-tp.fr">dimitri.mathieu@boumat-tp.fr</a><br />-->
<!--						- par téléphone : 06 78 34 54 83<br />-->
<!--						  ou<br />-->
<!--						  <b>Brigitte Colin :</b><br />-->
<!--						- par mail : <a href="mailto:brigitte-colin@wanadoo.fr">brigitte-colin@wanadoo.fr</a><br />-->
<!--						- par téléphone : 06 12 78 14 64<br /><br />-->
<!--					  </p>-->
<!--					</div>-->
<!--					<div class="dot_separator_items"></div>-->
<!--					<p><br />-->
<!--					<br />-->
<!--					BOUMAT TP : Siret 538047747 00018  - Décennale COVEA RISK : 120141277</p>-->
<!--				</div>-->
