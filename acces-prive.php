...
<!--            <h5 class="text-center text-white font-weight-bold my-4 visible border-text">ACCÈS PRIVÉ</h5>-->
            <!--desktop-->
            <h1 class="text-center text-white font-weight-bold my-4 border-text">Accès Privé</h1>
        </div>
    ...
    <!-- FIN IMAGE FIXE -->
        ...
        <div class="d-flex justify-content-between mx-3">
            <a href="/maconnerie.php" class="change-domain-btn btn ">Précédent</a>
            <a href="/revetement-divers.php" class="change-domain-btn btn ">Suivant</a>
        </div>
