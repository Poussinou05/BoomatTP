...
<!--            <h5 class="text-center text-white font-weight-bold my-4 visible border-text">REVÊTEMENT DIVERS</h5>-->
            <!--desktop-->
            <h1 class="text-center text-white font-weight-bold my-4 border-text">Revêtement Divers</h1>
        </div>
    ...
    <!-- FIN IMAGE FIXE -->
        ...
        <div class="d-flex justify-content-between mx-3">
            <a href="/acces-prive.php" class="change-domain-btn btn ">Précédent</a>
            <a href="/espaces-verts.php" class="change-domain-btn btn ">Suivant</a>
        </div>
